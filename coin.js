...
var Game = /** @class */ (function () {
    ...
    function Game(populationSize, winPercent, lossPercent, frameDelay, moneyPerPlayer) {
        this.Paused = true;
        ...
        this.WinPercent = winPercent !== null && winPercent !== void 0 ? winPercent : 60;
        this.LossPercent = lossPercent !== null && lossPercent !== void 0 ? lossPercent : 40;
        this.People = [];
    ...
    Game.prototype.CoinToss = function (a, winPercent, lossPercent) {
        var theyWon = (Math.random() < 0.5);
        if (theyWon) {
...
var TheGame;
function initGame(populationSize, winPercent, lossPercent, frameDelay, startLoop, moneyPerPlayer) {
